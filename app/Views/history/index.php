...
<body>
    <?php $active = 'history'; require __DIR__ . '/../partials/topbar.php'; ?>
    <div class="content">
        ...
        <form method="get" action="/history" class="form-card" style="margin-bottom:24px;max-width:none;">
            <div class="form-grid" style="grid-template-columns:repeat(5, 1fr);gap:12px;">
                <div class="field">
                    ...
                    <select id="client_id" name="client_id" style="width:100%;padding:10px 12px;border-radius:8px;border:1px solid #334155;background:#0f172a;color:#e2e8f0;">
                ...
                <div class="field">
                    ...
                    <select id="marketplace_id" name="marketplace_id" style="width:100%;padding:10px 12px;border-radius:8px;border:1px solid #334155;background:#0f172a;color:#e2e8f0;">
                        <option value="">Todos</option>
                ...
                <tbody>
                    <?php foreach ($entries as $entry): ?>
                        <tr>
                            ...
                            <td><span class="badge"><?= htmlspecialchars($entry['action'], ENT_QUOTES, 'UTF-8') ?></span></td>
                            <td>
        ...
        <p style="color:#94a3b8;font-size:0.85rem;">A limpeza remove apenas os registros de auditoria — os lançamentos (entries) não são afetados. Exporte o CSV acima antes de confirmar.</p>
        ...
        <div class="form-grid" style="grid-template-columns:1fr 1fr;gap:24px;">
            <form class="form-card" method="post" action="/history/clear-client" onsubmit="return confirm('Confirma a limpeza do histórico deste cliente? Essa ação não pode ser desfeita.');">
                ...
                <div class="field">
                    ...
                    <select id="clear_client_id" name="client_id" required style="width:100%;padding:10px 12px;border-radius:8px;border:1px solid #334155;background:#0f172a;color:#e2e8f0;">
                ...
                <button type="submit" class="btn" style="background:#ef4444;">Limpar histórico deste cliente</button>
            </form>
            ...
            <form class="form-card" method="post" action="/history/clear-all" onsubmit="return confirm('Confirma a limpeza de TODO o histórico do sistema? Essa ação não pode ser desfeita.');">
                ...
                <p style="color:#94a3b8;font-size:0.85rem;">Remove o histórico de todos os clientes.</p>
                <div class="field">
                ...
                <button type="submit" class="btn" style="background:#ef4444;">Limpar histórico geral</button>
            </form>
        </div>
    </div>
</body>
